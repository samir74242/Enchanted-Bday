...
export const defaultConfig: AppConfig = {
  ...
  "timeline": [
    ...
    },
    {
      ...
      "date": "  October 17, 2021",
      "title": "The First hug",
      "story": "And somehow, it brought us back to the very same stairs of that coaching institute. ❤️ This time, it wasn't just where our story began—it became a place for another beautiful memory. We shared chocolates 🍫, smiled at each other, and in that warm hug 🤗, we found a kind of comfort that words could never describe. It was such a simple moment, yet it meant everything to me. Sometimes, the smallest moments become the ones our hearts hold onto forever. 🥹❤️\n",
      "image": "https://images.unsplash.com/photo-1591969851586-adbbd4accf81?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D?q=80&w=600&auto=format&fit=crop",
      "icon": "Compass"
    },
    {
      "id": "t3",
    ...
    },
    {
      "id": "t4",
      "date": "January 1, 2024",
      "title": "Removed All the Boundaries",
      "story": "A year after that first video call, we had come so far. ❤️ What started with shy smiles and blushing had slowly turned into complete comfort with each other. 🥹✨ Somewhere along the way, we stopped counting the boundaries between us—they just faded away on their own. We trusted each other, understood each other, and shared parts of ourselves that we had never shared with anyone else. From being two strangers to becoming each other's safe place... it's a journey I'll always be grateful for. 🤍♾️\n",
      "image": "https://images.unsplash.com/photo-1540076156429-35ffe82b7870?q=80&w=600&auto=format&fit=crop",
      "icon": "Sparkles"
    }
  ],
  "gallery": [
  ...
  "clues": [
    {
      ...
      "secretImage": "/images/fiRSTTMEET.jpeg"
    },
    {
      "id": "c2",
  ...
  "cakeDecorationImage": "/images/cake_decoration.png"
};
